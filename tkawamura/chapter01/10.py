...
def main():
    ...
    # print("input SNR: ", calculate_snr(clean_down[filter_length:], noise[filter_length:]))
    # print("output SNR: ", calculate_snr(clean_down[filter_length:], noise_enhanced[filter_length:]))
